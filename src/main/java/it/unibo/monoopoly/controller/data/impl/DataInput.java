...
/**
 * The {@link record} built by a {@link DataBuilderInput} that packages the input data to the View.
 * 
 * @param cellMap could contains the entries player index -> amount of money.
 * @param dices could contains the {@link Pair} that represents two {@link Dices}.
 * @param event could contains the actual {@link Event} of the {@link MainModel}. 
